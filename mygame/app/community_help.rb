# INSTRUCTIONS
# Select all the text in here and paste it into "app/community_help.rb". Then require it at the top of "main.rb".
# Yes. All the text in this file is valid Ruby code.
...
# just add you help text to the CONTRIBUTING HELP AS JUST TEXT section.
...
# If you already know the class you need help on, add the line here:
class Array
